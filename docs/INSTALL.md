...
```bash
AGENTDIR_WHEEL=/path/to/agentdir-0.3.0-py3-none-any.whl bash scripts/install.sh
```

To force the virtual environment installer even when `pipx` is present:

```bash
AGENTDIR_FORCE_VENV=1 AGENTDIR_WHEEL=/path/to/agentdir-0.3.0-py3-none-any.whl bash scripts/install.sh
```
...
- `agentdir-0.3.0-py3-none-any.whl`
- `agentdir-0.3.0.tar.gz`
- `install-agentdir.sh`
